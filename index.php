  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="./" class="logo">
        ...
        <span class="logo-mini"><b>O<i class="fa fa-contao" aria-hidden="true"></i>CB</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>ON-<i class="fa fa-contao" aria-hidden="true"></i>ONTEST BIRD</b></span>
      </a>
      <!-- Header Navbar -->
